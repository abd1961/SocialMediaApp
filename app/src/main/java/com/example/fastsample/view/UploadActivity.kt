...
import com.example.fastsample.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    fun uploadImageView(view: View){
        ...
        if(ContextCompat.checkSelfPermission(this,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            ...
            //start activity for result launcher
        }

    }

    fun postButton(view: View){

        //universal unique id (uui)
        ...
        if (selectedPicture != null){
            ...
            //download url --> we should put it on firestore
